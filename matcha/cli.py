...
from matcha.utils.serialization import checkpoint_loading, load_checkpoint
...
def load_hifigan(checkpoint_path, device):
    ...
    hifigan.load_state_dict(load_checkpoint(checkpoint_path, map_location=device)["generator"])
    _ = hifigan.eval()
